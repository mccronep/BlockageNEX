...
#    r= 
    ...
    for pix in pixelx:
        ...
        if mycolor == 'lightgray' and mylgray ==0:
            ax.plot(theta_values,range_values,'o-', color=mycolor,label= blck_str)
            ax.legend()
            mylgray=1

        if mycolor == 'gray' and mygray ==0:
            ax.plot(theta_values,range_values,'o-', color=mycolor,label= blck_str)
            ax.legend()
            mygray=1

        if mycolor == 'blue' and myblue ==0:
           ax.plot(theta_values,range_values,'o-', color=mycolor,label= blck_str)
           ax.legend()
           myblue=1

        if mycolor == 'yellow' and myyellow ==0:
           ax.plot(theta_values,range_values,'o-', color=mycolor,label= blck_str)
           ax.legend()
           myyelow=1

        if mycolor == 'orange' and myorange ==0:
           ax.plot(theta_values,range_values,'o-', color=mycolor,label= blck_str)
           ax.legend()
           myorange=1

        if mycolor == 'red' and myred==0:
           ax.plot(theta_values,range_values,'o-', color=mycolor,label= blck_str)
           ax.legend()
           myred=1
        ...
        if mylgray ==1 and mygray==1 and myblue==1 and myyellow==1 and myorange==1 and myred==1:
