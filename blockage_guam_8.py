...
#    r= 
    ...
    ax.set_thetagrids([0,15,30,45,60,75,90,105,120,135,150,165,180,195,210,225,240,255,270,285,300,345])
...
# place a text box in upper left in axes coords
    ...
    ax.text(0.0, 1.0,textstr, transform=ax.transAxes, fontsize=14,verticalalignment='top', bbox=props)
